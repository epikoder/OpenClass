...
/* harmony import */ var stackedit_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! stackedit-js */ "./node_modules/stackedit-js/docs/lib/stackedit.js");
/* harmony import */ var stackedit_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(stackedit_js__WEBPACK_IMPORTED_MODULE_0__);
...
var markdown;
var stackedit = new stackedit_js__WEBPACK_IMPORTED_MODULE_0___default.a();
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.select2').select2();
jquery__WEBPACK_IMPORTED_MODULE_1___default()(".edit").on("click", function () {
  startEdit(false);
});
jquery__WEBPACK_IMPORTED_MODULE_1___default()(".new").on("click", function () {
  el.innerHTML = null;
  markdown = null;
});
jquery__WEBPACK_IMPORTED_MODULE_1___default()(".save").on("click", function () {
  var course = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".course").val();
  var chapter = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".chapter").val();
  var page = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".page").val();
  axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(postEditor, {
    page: page,
    markdown: markdown
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(".course").on("change", function () {
  var course = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".course").val();
  /** chapters is route */

  axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(chapters, {
    params: {
      course: course
    }
  }).then(function (response) {
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(".chapter").on("change", function () {
  var chapter = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".chapter").val();
  /** chapters is route */

  axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(pages, {
    params: {
      chapter: chapter
    }
  }).then(function (response) {
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.page').on('change', function () {
  var page = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.page').val();
  if (!page) return false;
  axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(pageSingle, {
    params: {
      page: page
    }
  }).then(function (response) {
...
function updateChapters(data) {
  var chapter = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".chapter").get([0]);
  chapter.innerHTML = '<option value="">Select chapter...</option>';
  data.forEach(function (item) {
    chapter.innerHTML += "<option value=" + item.id + ">" + item.name + "</option>";
  });
  var page = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".page").get([0]);
...
function updatePages(data) {
  ...
  page.innerHTML = '<option value="">Select page...</option>';
  data.forEach(function (item) {
    page.innerHTML += "<option value=" + item.id + ">" + item.page_num + "</option>";
  });
}
...
module.exports = __webpack_require__(/*! C:\Users\efedu\LabCodes\OpenClass\resources\js\editor.js */"./resources/js/editor.js");
